...
class Renamer {
    ...
    static {
        ...
        LogManager.rootLogger.addAppender(new FileAppender(simple,"/tmp/renamer.log",true))
    ...
    def Renamer(String basePath, String folderToOrganize) {
...
if (args.length > 1 && args[1].equals("-organize")) {
    ...
    def renamerScript = new Renamer(basePath, folderToOrganize)
