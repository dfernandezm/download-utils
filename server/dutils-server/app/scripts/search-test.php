...
/**
 * Test script which allows search in several torrent websites and extract relevant information from
 * the torrents such as title and torrent file / magnet link. This will be part of the TorrentSearchEngine
 * component of the Download Utils, but it can be used to generate a basic page and search avoiding annoying
 * ads and multiple navigation. Just type the search and get the results.
 * 
 * Sites supported:
 * 
 * - Elitetorrent
